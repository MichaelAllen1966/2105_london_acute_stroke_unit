...
ax1.plot(x, y2, marker='s', label='Bed pooling')
ax1.set_xlabel('ASU bed utilisation (%)')
ax1.set_ylabel('Percent patients who wait for ASU bed')
ax1.set_xlim(50, 100)
ax1.set_ylim(0)
ax1.legend()
ax1.grid()
ax1.set_title('A. Percent of patients who wait for an ASU bed')
...
ax3.plot(x, y2, marker='s', label='Bed pooling')
ax3.set_xlabel('ASU bed utilisation (%)')
ax3.set_ylabel('Average wait (days)')
ax3.set_xlim(50, 100)
ax3.set_ylim(0)
ax3.legend()
ax3.grid()
ax3.set_title('B. Average wait for ASU for those\npatients who have to wait for ASU bed')
...
ax4.plot(x, y2, marker='s', label='Bed pooling')
ax4.set_xlabel('ASU bed utilisation (%)')
ax4.set_ylabel('Average number of patients waiting for ASU bed')
ax4.set_xlim(50, 100)
ax4.set_ylim(0)
ax4.legend()
ax4.grid()
ax4.set_title('C. Average number of patients waiting for ASU bed')
...
ax2.plot(x, y2, marker='s', label='Bed pooling')
ax2.set_xlabel('ASU bed utilisation (%)')
ax2.set_ylabel('Percent patients displacedfrom catchment ASU')
ax2.set_xlim(50, 100)
ax2.set_ylim(0)
ax2.legend()
ax2.grid()
ax2.set_title('D. Percent of patients who are\ndisplaced from catchment ASU')
